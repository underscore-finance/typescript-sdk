...
import { LegoTools, v0_3_LegoHelper } from './getContracts.js'

type DeepMutable<T> = {
  -readonly [P in keyof T]: T[P] extends object ? DeepMutable<T[P]> : T[P]
}

export async function legacyGetSwapInstructionsAmountOut(
...
export async function legacyGetSwapInstructionsAmountIn(
  publicClient: PublicClient,
  walletAddress: Address,
  payload: {
    tokenIn: Address
