...
export const deployAddress: Address | undefined = '0x0f79a5A21dC0829ce3B4C72d75a94f67927Af9E9'
...
export function toSdk(
  ...
  return {
    ...
    events: {
      UnderscoreEarnVaultDeposit: {
        topic: getEventTopic('UnderscoreEarnVaultDeposit'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('UnderscoreEarnVaultDeposit', events),
      },
      UnderscoreEarnVaultWithdrawal: {
        topic: getEventTopic('UnderscoreEarnVaultWithdrawal'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('UnderscoreEarnVaultWithdrawal', events),
      },
      LegoPauseModified: {
