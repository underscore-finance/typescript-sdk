...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    ...
    vaultTokenToReserveId: (...args: ExtractArgs<Contract['calls']['vaultTokenToReserveId']>) =>
      singleQuery(publicClient!, call.vaultTokenToReserveId(...args)) as Promise<CallReturn<'vaultTokenToReserveId'>>,
    EXTRAFI_POOL: (...args: ExtractArgs<Contract['calls']['EXTRAFI_POOL']>) =>
      singleQuery(publicClient!, call.EXTRAFI_POOL(...args)) as Promise<CallReturn<'EXTRAFI_POOL'>>,
    ...
    registerVaultTokensGlobally: (...args: ExtractArgs<Contract['mutations']['registerVaultTokensGlobally']>) =>
      mutate(walletClient!, mutation.registerVaultTokensGlobally)(...args),
