...
export type Contract = {
  ...
  mutations: {
    ...
    recoverTrialFunds: (wallet: `0x${string}`, opportunities?: { legoId: bigint; vaultToken: `0x${string}` }[]) => Promise<boolean>
...
export const call: CallType = {
		...
		currentUserWalletTemplate: (...args: ExtractArgs<Contract['calls']['currentUserWalletTemplate']>) => getRequest('currentUserWalletTemplate', args),
		currentUserWalletConfigTemplate: (...args: ExtractArgs<Contract['calls']['currentUserWalletConfigTemplate']>) => getRequest('currentUserWalletConfigTemplate', args),
		currentAgentTemplate: (...args: ExtractArgs<Contract['calls']['currentAgentTemplate']>) => getRequest('currentAgentTemplate', args),
		isValidUserWalletSetup: (...args: ExtractArgs<Contract['calls']['isValidUserWalletSetup']>) => getRequest('isValidUserWalletSetup', args),
		isValidUserWalletTemplate: (...args: ExtractArgs<Contract['calls']['isValidUserWalletTemplate']>) => getRequest('isValidUserWalletTemplate', args),
		isValidUserWalletConfigTemplate: (...args: ExtractArgs<Contract['calls']['isValidUserWalletConfigTemplate']>) => getRequest('isValidUserWalletConfigTemplate', args),
		isValidAgentSetup: (...args: ExtractArgs<Contract['calls']['isValidAgentSetup']>) => getRequest('isValidAgentSetup', args),
		isValidAgentTemplate: (...args: ExtractArgs<Contract['calls']['isValidAgentTemplate']>) => getRequest('isValidAgentTemplate', args),
		isValidTrialFundsData: (...args: ExtractArgs<Contract['calls']['isValidTrialFundsData']>) => getRequest('isValidTrialFundsData', args),
		trialFundsData: (...args: ExtractArgs<Contract['calls']['trialFundsData']>) => getRequest('trialFundsData', args),
		userWalletTemplate: (...args: ExtractArgs<Contract['calls']['userWalletTemplate']>) => getRequest('userWalletTemplate', args),
		userWalletConfig: (...args: ExtractArgs<Contract['calls']['userWalletConfig']>) => getRequest('userWalletConfig', args),
		...
		agentTemplateInfo: (...args: ExtractArgs<Contract['calls']['agentTemplateInfo']>) => getRequest('agentTemplateInfo', args),
		...
		numUserWalletsAllowed: (...args: ExtractArgs<Contract['calls']['numUserWalletsAllowed']>) => getRequest('numUserWalletsAllowed', args),
		numAgentsAllowed: (...args: ExtractArgs<Contract['calls']['numAgentsAllowed']>) => getRequest('numAgentsAllowed', args),
		whitelist: (...args: ExtractArgs<Contract['calls']['whitelist']>) => getRequest('whitelist', args),
		shouldEnforceWhitelist: (...args: ExtractArgs<Contract['calls']['shouldEnforceWhitelist']>) => getRequest('shouldEnforceWhitelist', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		currentUserWalletTemplate: (...args: ExtractArgs<Contract['calls']['currentUserWalletTemplate']>) => singleQuery(publicClient!, call.currentUserWalletTemplate(...args)) as Promise<CallReturn<'currentUserWalletTemplate'>>,
		currentUserWalletConfigTemplate: (...args: ExtractArgs<Contract['calls']['currentUserWalletConfigTemplate']>) => singleQuery(publicClient!, call.currentUserWalletConfigTemplate(...args)) as Promise<CallReturn<'currentUserWalletConfigTemplate'>>,
		currentAgentTemplate: (...args: ExtractArgs<Contract['calls']['currentAgentTemplate']>) => singleQuery(publicClient!, call.currentAgentTemplate(...args)) as Promise<CallReturn<'currentAgentTemplate'>>,
		isValidUserWalletSetup: (...args: ExtractArgs<Contract['calls']['isValidUserWalletSetup']>) => singleQuery(publicClient!, call.isValidUserWalletSetup(...args)) as Promise<CallReturn<'isValidUserWalletSetup'>>,
		isValidUserWalletTemplate: (...args: ExtractArgs<Contract['calls']['isValidUserWalletTemplate']>) => singleQuery(publicClient!, call.isValidUserWalletTemplate(...args)) as Promise<CallReturn<'isValidUserWalletTemplate'>>,
		isValidUserWalletConfigTemplate: (...args: ExtractArgs<Contract['calls']['isValidUserWalletConfigTemplate']>) => singleQuery(publicClient!, call.isValidUserWalletConfigTemplate(...args)) as Promise<CallReturn<'isValidUserWalletConfigTemplate'>>,
		isValidAgentSetup: (...args: ExtractArgs<Contract['calls']['isValidAgentSetup']>) => singleQuery(publicClient!, call.isValidAgentSetup(...args)) as Promise<CallReturn<'isValidAgentSetup'>>,
		isValidAgentTemplate: (...args: ExtractArgs<Contract['calls']['isValidAgentTemplate']>) => singleQuery(publicClient!, call.isValidAgentTemplate(...args)) as Promise<CallReturn<'isValidAgentTemplate'>>,
		isValidTrialFundsData: (...args: ExtractArgs<Contract['calls']['isValidTrialFundsData']>) => singleQuery(publicClient!, call.isValidTrialFundsData(...args)) as Promise<CallReturn<'isValidTrialFundsData'>>,
		trialFundsData: (...args: ExtractArgs<Contract['calls']['trialFundsData']>) => singleQuery(publicClient!, call.trialFundsData(...args)) as Promise<CallReturn<'trialFundsData'>>,
		userWalletTemplate: (...args: ExtractArgs<Contract['calls']['userWalletTemplate']>) => singleQuery(publicClient!, call.userWalletTemplate(...args)) as Promise<CallReturn<'userWalletTemplate'>>,
		userWalletConfig: (...args: ExtractArgs<Contract['calls']['userWalletConfig']>) => singleQuery(publicClient!, call.userWalletConfig(...args)) as Promise<CallReturn<'userWalletConfig'>>,
		isUserWallet: (...args: ExtractArgs<Contract['calls']['isUserWallet']>) => singleQuery(publicClient!, call.isUserWallet(...args)) as Promise<CallReturn<'isUserWallet'>>,
		numUserWallets: (...args: ExtractArgs<Contract['calls']['numUserWallets']>) => singleQuery(publicClient!, call.numUserWallets(...args)) as Promise<CallReturn<'numUserWallets'>>,
		agentTemplateInfo: (...args: ExtractArgs<Contract['calls']['agentTemplateInfo']>) => singleQuery(publicClient!, call.agentTemplateInfo(...args)) as Promise<CallReturn<'agentTemplateInfo'>>,
		isAgent: (...args: ExtractArgs<Contract['calls']['isAgent']>) => singleQuery(publicClient!, call.isAgent(...args)) as Promise<CallReturn<'isAgent'>>,
		numAgents: (...args: ExtractArgs<Contract['calls']['numAgents']>) => singleQuery(publicClient!, call.numAgents(...args)) as Promise<CallReturn<'numAgents'>>,
		agentBlacklist: (...args: ExtractArgs<Contract['calls']['agentBlacklist']>) => singleQuery(publicClient!, call.agentBlacklist(...args)) as Promise<CallReturn<'agentBlacklist'>>,
		numUserWalletsAllowed: (...args: ExtractArgs<Contract['calls']['numUserWalletsAllowed']>) => singleQuery(publicClient!, call.numUserWalletsAllowed(...args)) as Promise<CallReturn<'numUserWalletsAllowed'>>,
		numAgentsAllowed: (...args: ExtractArgs<Contract['calls']['numAgentsAllowed']>) => singleQuery(publicClient!, call.numAgentsAllowed(...args)) as Promise<CallReturn<'numAgentsAllowed'>>,
		whitelist: (...args: ExtractArgs<Contract['calls']['whitelist']>) => singleQuery(publicClient!, call.whitelist(...args)) as Promise<CallReturn<'whitelist'>>,
		shouldEnforceWhitelist: (...args: ExtractArgs<Contract['calls']['shouldEnforceWhitelist']>) => singleQuery(publicClient!, call.shouldEnforceWhitelist(...args)) as Promise<CallReturn<'shouldEnforceWhitelist'>>,
		...
		WETH_ADDR: (...args: ExtractArgs<Contract['calls']['WETH_ADDR']>) => singleQuery(publicClient!, call.WETH_ADDR(...args)) as Promise<CallReturn<'WETH_ADDR'>>,
    
    // Mutations
		setLocalGovernor: (...args: ExtractArgs<Contract['mutations']['setLocalGovernor']>) => mutate(walletClient!, mutation.setLocalGovernor)(...args),
		createUserWallet: (...args: ExtractArgs<Contract['mutations']['createUserWallet']>) => mutate(walletClient!, mutation.createUserWallet)(...args),
		setUserWalletTemplate: (...args: ExtractArgs<Contract['mutations']['setUserWalletTemplate']>) => mutate(walletClient!, mutation.setUserWalletTemplate)(...args),
		setUserWalletConfigTemplate: (...args: ExtractArgs<Contract['mutations']['setUserWalletConfigTemplate']>) => mutate(walletClient!, mutation.setUserWalletConfigTemplate)(...args),
		createAgent: (...args: ExtractArgs<Contract['mutations']['createAgent']>) => mutate(walletClient!, mutation.createAgent)(...args),
		setAgentTemplate: (...args: ExtractArgs<Contract['mutations']['setAgentTemplate']>) => mutate(walletClient!, mutation.setAgentTemplate)(...args),
		setTrialFundsData: (...args: ExtractArgs<Contract['mutations']['setTrialFundsData']>) => mutate(walletClient!, mutation.setTrialFundsData)(...args),
		setWhitelist: (...args: ExtractArgs<Contract['mutations']['setWhitelist']>) => mutate(walletClient!, mutation.setWhitelist)(...args),
		setShouldEnforceWhitelist: (...args: ExtractArgs<Contract['mutations']['setShouldEnforceWhitelist']>) => mutate(walletClient!, mutation.setShouldEnforceWhitelist)(...args),
		setNumUserWalletsAllowed: (...args: ExtractArgs<Contract['mutations']['setNumUserWalletsAllowed']>) => mutate(walletClient!, mutation.setNumUserWalletsAllowed)(...args),
		setNumAgentsAllowed: (...args: ExtractArgs<Contract['mutations']['setNumAgentsAllowed']>) => mutate(walletClient!, mutation.setNumAgentsAllowed)(...args),
		setAgentBlacklist: (...args: ExtractArgs<Contract['mutations']['setAgentBlacklist']>) => mutate(walletClient!, mutation.setAgentBlacklist)(...args),
		recoverFunds: (...args: ExtractArgs<Contract['mutations']['recoverFunds']>) => mutate(walletClient!, mutation.recoverFunds)(...args),
		recoverTrialFunds: (...args: ExtractArgs<Contract['mutations']['recoverTrialFunds']>) => mutate(walletClient!, mutation.recoverTrialFunds)(...args),
