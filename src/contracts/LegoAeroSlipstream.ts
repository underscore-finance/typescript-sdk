...
export type Contract = {
  ...
  events: {
    AeroSlipStreamSwap: (sender: `0x${string}`, tokenIn: `0x${string}`, tokenOut: `0x${string}`, amountIn: bigint, amountOut: bigint, usdValue: bigint, numTokens: bigint, recipient: `0x${string}`) => Promise<void>
    AeroSlipStreamLiquidityAdded: (sender: `0x${string}`, tokenA: `0x${string}`, tokenB: `0x${string}`, amountA: bigint, amountB: bigint, liquidityAdded: bigint, nftTokenId: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    AeroSlipStreamLiquidityRemoved: (sender: `0x${string}`, pool: `0x${string}`, nftTokenId: bigint, tokenA: `0x${string}`, tokenB: `0x${string}`, amountA: bigint, amountB: bigint, liquidityRemoved: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    ...
    AeroSlipStreamNftRecovered: (collection: `0x${string}`, nftTokenId: bigint, recipient: `0x${string}`) => Promise<void>
...
export const call: CallType = {
		...
		onERC721Received: (...args: ExtractArgs<Contract['calls']['onERC721Received']>) => getRequest('onERC721Received', args),
		...
		AERO_SLIPSTREAM_FACTORY: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_FACTORY']>) => getRequest('AERO_SLIPSTREAM_FACTORY', args),
		AERO_SLIPSTREAM_NFT_MANAGER: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_NFT_MANAGER']>) => getRequest('AERO_SLIPSTREAM_NFT_MANAGER', args),
		AERO_SLIPSTREAM_QUOTER: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_QUOTER']>) => getRequest('AERO_SLIPSTREAM_QUOTER', args),
...
export type SDK = {
		...
		AERO_SLIPSTREAM_FACTORY: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_FACTORY']>) => Promise<CallReturn<'AERO_SLIPSTREAM_FACTORY'>>
		AERO_SLIPSTREAM_NFT_MANAGER: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_NFT_MANAGER']>) => Promise<CallReturn<'AERO_SLIPSTREAM_NFT_MANAGER'>>
		AERO_SLIPSTREAM_QUOTER: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_QUOTER']>) => Promise<CallReturn<'AERO_SLIPSTREAM_QUOTER'>>
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		onERC721Received: (...args: ExtractArgs<Contract['calls']['onERC721Received']>) => singleQuery(publicClient!, call.onERC721Received(...args)) as Promise<CallReturn<'onERC721Received'>>,
		...
		AERO_SLIPSTREAM_FACTORY: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_FACTORY']>) => singleQuery(publicClient!, call.AERO_SLIPSTREAM_FACTORY(...args)) as Promise<CallReturn<'AERO_SLIPSTREAM_FACTORY'>>,
		AERO_SLIPSTREAM_NFT_MANAGER: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_NFT_MANAGER']>) => singleQuery(publicClient!, call.AERO_SLIPSTREAM_NFT_MANAGER(...args)) as Promise<CallReturn<'AERO_SLIPSTREAM_NFT_MANAGER'>>,
		AERO_SLIPSTREAM_QUOTER: (...args: ExtractArgs<Contract['calls']['AERO_SLIPSTREAM_QUOTER']>) => singleQuery(publicClient!, call.AERO_SLIPSTREAM_QUOTER(...args)) as Promise<CallReturn<'AERO_SLIPSTREAM_QUOTER'>>,
    ...
    // Mutations
		...
		uniswapV3SwapCallback: (...args: ExtractArgs<Contract['mutations']['uniswapV3SwapCallback']>) => mutate(walletClient!, mutation.uniswapV3SwapCallback)(...args),
		...
		getBestSwapAmountOut: (...args: ExtractArgs<Contract['mutations']['getBestSwapAmountOut']>) => mutate(walletClient!, mutation.getBestSwapAmountOut)(...args),
		getSwapAmountOut: (...args: ExtractArgs<Contract['mutations']['getSwapAmountOut']>) => mutate(walletClient!, mutation.getSwapAmountOut)(...args),
		getBestSwapAmountIn: (...args: ExtractArgs<Contract['mutations']['getBestSwapAmountIn']>) => mutate(walletClient!, mutation.getBestSwapAmountIn)(...args),
		getSwapAmountIn: (...args: ExtractArgs<Contract['mutations']['getSwapAmountIn']>) => mutate(walletClient!, mutation.getSwapAmountIn)(...args),
		...
		recoverNft: (...args: ExtractArgs<Contract['mutations']['recoverNft']>) => mutate(walletClient!, mutation.recoverNft)(...args),
