...
export const deployAddress: Address | undefined = '0x8cC1729066d5fEaDe4C9326C3f001c42bEFD57EB'
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    ...
    slippage: (...args: ExtractArgs<Contract['calls']['slippage']>) =>
      singleQuery(publicClient!, call.slippage(...args)) as Promise<CallReturn<'slippage'>>,
    ...
    setSlippage: (...args: ExtractArgs<Contract['mutations']['setSlippage']>) =>
      mutate(walletClient!, mutation.setSlippage)(...args),
