...
export const deployAddress: Address | undefined = '0xEe7B4F2338389A6453E85a65976F3241986492CF'
...
export type Contract = {
  ...
  mutations: {
    ...
    setSlippage: (slippage: bigint) => Promise<boolean>
    claimRewards: (
      user: `0x${string}`,
  ...
  events: {
    ...
    SlippageSet: (slippage: bigint) => Promise<void>
...
export const call: CallType = {
  ...
  slippage: (...args: ExtractArgs<Contract['calls']['slippage']>) => getRequest('slippage', args),
...
export type SDK = {
  ...
  abi: typeof abi
  events: {
    SkyPsmDeposit: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'SkyPsmDeposit'>[] }
    SkyPsmWithdrawal: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'SkyPsmWithdrawal'>[] }
    SlippageSet: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'SlippageSet'>[] }
  ...
  slippage: (...args: ExtractArgs<Contract['calls']['slippage']>) => Promise<CallReturn<'slippage'>>
  ...
  setSlippage: (...args: ExtractArgs<Contract['mutations']['setSlippage']>) => Promise<Address>
...
export function toSdk(
  ...
  return {
    ...
    events: {
      SkyPsmDeposit: {
        topic: getEventTopic('SkyPsmDeposit'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('SkyPsmDeposit', events),
      },
      SkyPsmWithdrawal: {
        topic: getEventTopic('SkyPsmWithdrawal'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('SkyPsmWithdrawal', events),
      },
      SlippageSet: {
        topic: getEventTopic('SlippageSet'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('SlippageSet', events),
      },
      LegoPauseModified: {
    ...
    hasClaimableRewards: (...args: ExtractArgs<Contract['calls']['hasClaimableRewards']>) =>
      ...
      >,
    slippage: (...args: ExtractArgs<Contract['calls']['slippage']>) =>
      singleQuery(publicClient!, call.slippage(...args), {}, addressResolver) as Promise<CallReturn<'slippage'>>,
    SKY_PSM: (...args: ExtractArgs<Contract['calls']['SKY_PSM']>) =>
      singleQuery(publicClient!, call.SKY_PSM(...args), {}, addressResolver) as Promise<CallReturn<'SKY_PSM'>>,
    USDS: (...args: ExtractArgs<Contract['calls']['USDS']>) =>
      singleQuery(publicClient!, call.USDS(...args), {}, addressResolver) as Promise<CallReturn<'USDS'>>,
    SUSDS: (...args: ExtractArgs<Contract['calls']['SUSDS']>) =>
      singleQuery(publicClient!, call.SUSDS(...args), {}, addressResolver) as Promise<CallReturn<'SUSDS'>>,
    ...
    setSlippage: (...args: ExtractArgs<Contract['mutations']['setSlippage']>) =>
      mutate(walletClient!, mutation.setSlippage, { addressResolver })(...args),
