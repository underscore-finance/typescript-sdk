...
export type Contract = {
  ...
  events: {
    MorphoDeposit: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountDeposited: bigint, usdValue: bigint, vaultTokenAmountReceived: bigint, recipient: `0x${string}`) => Promise<void>
    MorphoWithdrawal: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountReceived: bigint, usdValue: bigint, vaultTokenAmountBurned: bigint, recipient: `0x${string}`) => Promise<void>
    MorphoRewardsAddrSet: (addr: `0x${string}`) => Promise<void>
    MorphoFundsRecovered: (asset: `0x${string}`, recipient: `0x${string}`, amount: bigint) => Promise<void>
...
function getRequest<M extends Calls>(
  ...
  | {
    ...
    const call = {
      contractName: 'LegoMorpho' as const,
      method,
      args,
      address,
      deployAddress,
...
export const call: CallType = {
		...
		morphoRewards: (...args: ExtractArgs<Contract['calls']['morphoRewards']>) => getRequest('morphoRewards', args),
		MORPHO_FACTORY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY']>) => getRequest('MORPHO_FACTORY', args),
		MORPHO_FACTORY_LEGACY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY_LEGACY']>) => getRequest('MORPHO_FACTORY_LEGACY', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		morphoRewards: (...args: ExtractArgs<Contract['calls']['morphoRewards']>) => singleQuery(publicClient!, call.morphoRewards(...args)) as Promise<CallReturn<'morphoRewards'>>,
		MORPHO_FACTORY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY']>) => singleQuery(publicClient!, call.MORPHO_FACTORY(...args)) as Promise<CallReturn<'MORPHO_FACTORY'>>,
		MORPHO_FACTORY_LEGACY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY_LEGACY']>) => singleQuery(publicClient!, call.MORPHO_FACTORY_LEGACY(...args)) as Promise<CallReturn<'MORPHO_FACTORY_LEGACY'>>,
    ...
    // Mutations
		...
		setMorphoRewardsAddr: (...args: ExtractArgs<Contract['mutations']['setMorphoRewardsAddr']>) => mutate(walletClient!, mutation.setMorphoRewardsAddr)(...args),
