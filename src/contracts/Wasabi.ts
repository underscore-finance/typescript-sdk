...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    ...
    WASABI_LONG_POOL: (...args: ExtractArgs<Contract['calls']['WASABI_LONG_POOL']>) =>
      singleQuery(publicClient!, call.WASABI_LONG_POOL(...args)) as Promise<CallReturn<'WASABI_LONG_POOL'>>,
    WASABI_SHORT_POOL: (...args: ExtractArgs<Contract['calls']['WASABI_SHORT_POOL']>) =>
      singleQuery(publicClient!, call.WASABI_SHORT_POOL(...args)) as Promise<CallReturn<'WASABI_SHORT_POOL'>>,
