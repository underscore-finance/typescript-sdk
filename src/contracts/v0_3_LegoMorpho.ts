...
export const deployAddress: Address | undefined = '0x825309418B066603C2732fdA08d39A79CAA5CC8e'
...
function getRequest<M extends Calls>(
  ...
  const call = {
    contractName: 'v0_3_LegoMorpho' as const,
    method,
    args,
    address,
    deployAddress,
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    ...
    morphoRewards: (...args: ExtractArgs<Contract['calls']['morphoRewards']>) =>
      singleQuery(publicClient!, call.morphoRewards(...args)) as Promise<CallReturn<'morphoRewards'>>,
    MORPHO_FACTORY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY']>) =>
      singleQuery(publicClient!, call.MORPHO_FACTORY(...args)) as Promise<CallReturn<'MORPHO_FACTORY'>>,
    MORPHO_FACTORY_LEGACY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY_LEGACY']>) =>
      singleQuery(publicClient!, call.MORPHO_FACTORY_LEGACY(...args)) as Promise<CallReturn<'MORPHO_FACTORY_LEGACY'>>,
