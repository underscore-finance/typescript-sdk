...
export const deployAddress: Address | undefined = '0x95979aEF0F70887f31701944b658948890F56fd7'
...
function getRequest<M extends Calls>(
  ...
  const call = {
    contractName: 'UniswapV2' as const,
    method,
    args,
    address,
    deployAddress,
...
export type SDK = {
  ...
  abi: typeof abi
  events: {
    UniswapV2Swap: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'UniswapV2Swap'>[] }
    UniswapV2LiquidityAdded: {
      topic: Address
      parse: (events: (RpcLog | Log)[]) => ParsedEvent<'UniswapV2LiquidityAdded'>[]
    }
    UniswapV2LiquidityRemoved: {
      topic: Address
      parse: (events: (RpcLog | Log)[]) => ParsedEvent<'UniswapV2LiquidityRemoved'>[]
    }
...
export function toSdk(
  ...
  return {
    ...
    events: {
      UniswapV2Swap: {
        topic: getEventTopic('UniswapV2Swap'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('UniswapV2Swap', events),
      },
      UniswapV2LiquidityAdded: {
        topic: getEventTopic('UniswapV2LiquidityAdded'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('UniswapV2LiquidityAdded', events),
      },
      UniswapV2LiquidityRemoved: {
        topic: getEventTopic('UniswapV2LiquidityRemoved'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('UniswapV2LiquidityRemoved', events),
      },
      LegoPauseModified: {
    ...
    getAccessForLego: (...args: ExtractArgs<Contract['calls']['getAccessForLego']>) =>
      ...
      >,
    UNISWAP_V2_FACTORY: (...args: ExtractArgs<Contract['calls']['UNISWAP_V2_FACTORY']>) =>
      singleQuery(publicClient!, call.UNISWAP_V2_FACTORY(...args), {}, addressResolver) as Promise<
        CallReturn<'UNISWAP_V2_FACTORY'>
      >,
    UNISWAP_V2_ROUTER: (...args: ExtractArgs<Contract['calls']['UNISWAP_V2_ROUTER']>) =>
      singleQuery(publicClient!, call.UNISWAP_V2_ROUTER(...args), {}, addressResolver) as Promise<
        CallReturn<'UNISWAP_V2_ROUTER'>
      >,
