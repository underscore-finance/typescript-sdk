...
export type Contract = {
  calls: {
    ...
    getLegoInfo: (legoId: bigint) => Promise<{ addr: `0x${string}`; version: bigint; lastModified: bigint; description: string; legoType: bigint }>
    ...
    legoInfo: (arg0: bigint) => Promise<{ addr: `0x${string}`; version: bigint; lastModified: bigint; description: string; legoType: bigint }>
...
export const call: CallType = {
		...
		isValidNewLegoAddr: (...args: ExtractArgs<Contract['calls']['isValidNewLegoAddr']>) => getRequest('isValidNewLegoAddr', args),
		isValidLegoUpdate: (...args: ExtractArgs<Contract['calls']['isValidLegoUpdate']>) => getRequest('isValidLegoUpdate', args),
		isValidLegoDisable: (...args: ExtractArgs<Contract['calls']['isValidLegoDisable']>) => getRequest('isValidLegoDisable', args),
		...
		getLegoDescription: (...args: ExtractArgs<Contract['calls']['getLegoDescription']>) => getRequest('getLegoDescription', args),
		...
		getUnderlyingForUser: (...args: ExtractArgs<Contract['calls']['getUnderlyingForUser']>) => getRequest('getUnderlyingForUser', args),
		isValidLegoHelper: (...args: ExtractArgs<Contract['calls']['isValidLegoHelper']>) => getRequest('isValidLegoHelper', args),
...
export type SDK = {
		...
		getLegoDescription: (...args: ExtractArgs<Contract['calls']['getLegoDescription']>) => Promise<CallReturn<'getLegoDescription'>>
		getNumLegos: (...args: ExtractArgs<Contract['calls']['getNumLegos']>) => Promise<CallReturn<'getNumLegos'>>
		getLastLegoAddr: (...args: ExtractArgs<Contract['calls']['getLastLegoAddr']>) => Promise<CallReturn<'getLastLegoAddr'>>
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		isValidNewLegoAddr: (...args: ExtractArgs<Contract['calls']['isValidNewLegoAddr']>) => singleQuery(publicClient!, call.isValidNewLegoAddr(...args)) as Promise<CallReturn<'isValidNewLegoAddr'>>,
		isValidLegoUpdate: (...args: ExtractArgs<Contract['calls']['isValidLegoUpdate']>) => singleQuery(publicClient!, call.isValidLegoUpdate(...args)) as Promise<CallReturn<'isValidLegoUpdate'>>,
		isValidLegoDisable: (...args: ExtractArgs<Contract['calls']['isValidLegoDisable']>) => singleQuery(publicClient!, call.isValidLegoDisable(...args)) as Promise<CallReturn<'isValidLegoDisable'>>,
		isValidLegoAddr: (...args: ExtractArgs<Contract['calls']['isValidLegoAddr']>) => singleQuery(publicClient!, call.isValidLegoAddr(...args)) as Promise<CallReturn<'isValidLegoAddr'>>,
		isValidLegoId: (...args: ExtractArgs<Contract['calls']['isValidLegoId']>) => singleQuery(publicClient!, call.isValidLegoId(...args)) as Promise<CallReturn<'isValidLegoId'>>,
		getLegoId: (...args: ExtractArgs<Contract['calls']['getLegoId']>) => singleQuery(publicClient!, call.getLegoId(...args)) as Promise<CallReturn<'getLegoId'>>,
		getLegoAddr: (...args: ExtractArgs<Contract['calls']['getLegoAddr']>) => singleQuery(publicClient!, call.getLegoAddr(...args)) as Promise<CallReturn<'getLegoAddr'>>,
		getLegoInfo: (...args: ExtractArgs<Contract['calls']['getLegoInfo']>) => singleQuery(publicClient!, call.getLegoInfo(...args)) as Promise<CallReturn<'getLegoInfo'>>,
		getLegoDescription: (...args: ExtractArgs<Contract['calls']['getLegoDescription']>) => singleQuery(publicClient!, call.getLegoDescription(...args)) as Promise<CallReturn<'getLegoDescription'>>,
		getNumLegos: (...args: ExtractArgs<Contract['calls']['getNumLegos']>) => singleQuery(publicClient!, call.getNumLegos(...args)) as Promise<CallReturn<'getNumLegos'>>,
		getLastLegoAddr: (...args: ExtractArgs<Contract['calls']['getLastLegoAddr']>) => singleQuery(publicClient!, call.getLastLegoAddr(...args)) as Promise<CallReturn<'getLastLegoAddr'>>,
		getLastLegoId: (...args: ExtractArgs<Contract['calls']['getLastLegoId']>) => singleQuery(publicClient!, call.getLastLegoId(...args)) as Promise<CallReturn<'getLastLegoId'>>,
		...
		getUnderlyingForUser: (...args: ExtractArgs<Contract['calls']['getUnderlyingForUser']>) => singleQuery(publicClient!, call.getUnderlyingForUser(...args)) as Promise<CallReturn<'getUnderlyingForUser'>>,
		isValidLegoHelper: (...args: ExtractArgs<Contract['calls']['isValidLegoHelper']>) => singleQuery(publicClient!, call.isValidLegoHelper(...args)) as Promise<CallReturn<'isValidLegoHelper'>>,
		legoHelper: (...args: ExtractArgs<Contract['calls']['legoHelper']>) => singleQuery(publicClient!, call.legoHelper(...args)) as Promise<CallReturn<'legoHelper'>>,
		legoInfo: (...args: ExtractArgs<Contract['calls']['legoInfo']>) => singleQuery(publicClient!, call.legoInfo(...args)) as Promise<CallReturn<'legoInfo'>>,
		legoAddrToId: (...args: ExtractArgs<Contract['calls']['legoAddrToId']>) => singleQuery(publicClient!, call.legoAddrToId(...args)) as Promise<CallReturn<'legoAddrToId'>>,
		numLegos: (...args: ExtractArgs<Contract['calls']['numLegos']>) => singleQuery(publicClient!, call.numLegos(...args)) as Promise<CallReturn<'numLegos'>>,
    ...
    // Mutations
		...
		registerNewLego: (...args: ExtractArgs<Contract['mutations']['registerNewLego']>) => mutate(walletClient!, mutation.registerNewLego)(...args),
		updateLegoAddr: (...args: ExtractArgs<Contract['mutations']['updateLegoAddr']>) => mutate(walletClient!, mutation.updateLegoAddr)(...args),
		disableLegoAddr: (...args: ExtractArgs<Contract['mutations']['disableLegoAddr']>) => mutate(walletClient!, mutation.disableLegoAddr)(...args),
		setLegoHelper: (...args: ExtractArgs<Contract['mutations']['setLegoHelper']>) => mutate(walletClient!, mutation.setLegoHelper)(...args),
  }
}
