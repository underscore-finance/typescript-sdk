...
function getRequest<M extends Calls>(
  ...
  | {
    ...
    const call = {
      contractName: 'LegoFluid' as const,
      method,
      args,
      address,
      deployAddress,
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		FLUID_RESOLVER: (...args: ExtractArgs<Contract['calls']['FLUID_RESOLVER']>) => singleQuery(publicClient!, call.FLUID_RESOLVER(...args)) as Promise<CallReturn<'FLUID_RESOLVER'>>,
