...
export type SDK = {
  ...
  events: {
    ...
    RipeBorrow: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'RipeBorrow'>[] }
    RipeRepay: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'RipeRepay'>[] }
    RipeClaimRewards: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'RipeClaimRewards'>[] }
    RipeSavingsGreenDeposit: {
      topic: Address
    ...
    RipeEndaomentPsmSwap: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'RipeEndaomentPsmSwap'>[] }
...
export function toSdk(
  ...
  return {
    ...
    events: {
      RipeCollateralDeposit: {
        topic: getEventTopic('RipeCollateralDeposit'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeCollateralDeposit', events),
      },
      RipeCollateralWithdrawal: {
        topic: getEventTopic('RipeCollateralWithdrawal'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeCollateralWithdrawal', events),
      },
      RipeBorrow: {
        topic: getEventTopic('RipeBorrow'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeBorrow', events),
      },
      RipeRepay: {
        topic: getEventTopic('RipeRepay'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeRepay', events),
      },
      RipeClaimRewards: {
        topic: getEventTopic('RipeClaimRewards'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeClaimRewards', events),
      },
      RipeSavingsGreenDeposit: {
        topic: getEventTopic('RipeSavingsGreenDeposit'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeSavingsGreenDeposit', events),
      },
      RipeSavingsGreenWithdrawal: {
        topic: getEventTopic('RipeSavingsGreenWithdrawal'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeSavingsGreenWithdrawal', events),
      },
      RipeEndaomentPsmSwap: {
        topic: getEventTopic('RipeEndaomentPsmSwap'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('RipeEndaomentPsmSwap', events),
      },
      LegoPauseModified: {
    ...
    deleverageWithSpecificAssets: (...args: ExtractArgs<Contract['mutations']['deleverageWithSpecificAssets']>) =>
      mutate(walletClient!, mutation.deleverageWithSpecificAssets, { addressResolver })(...args),
    deleverageUser: (...args: ExtractArgs<Contract['mutations']['deleverageUser']>) =>
      mutate(walletClient!, mutation.deleverageUser, { addressResolver })(...args),
