...
export type Contract = {
  calls: {
    ...
    getAddyInfo: (addyId: bigint) => Promise<{ addr: `0x${string}`; version: bigint; lastModified: bigint; description: string }>
    ...
    addyInfo: (arg0: bigint) => Promise<{ addr: `0x${string}`; version: bigint; lastModified: bigint; description: string }>
...
export const call: CallType = {
		...
		isValidAddyUpdate: (...args: ExtractArgs<Contract['calls']['isValidAddyUpdate']>) => getRequest('isValidAddyUpdate', args),
		isValidAddyDisable: (...args: ExtractArgs<Contract['calls']['isValidAddyDisable']>) => getRequest('isValidAddyDisable', args),
		...
		getAddyDescription: (...args: ExtractArgs<Contract['calls']['getAddyDescription']>) => getRequest('getAddyDescription', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		isValidNewAddy: (...args: ExtractArgs<Contract['calls']['isValidNewAddy']>) => singleQuery(publicClient!, call.isValidNewAddy(...args)) as Promise<CallReturn<'isValidNewAddy'>>,
		isValidAddyUpdate: (...args: ExtractArgs<Contract['calls']['isValidAddyUpdate']>) => singleQuery(publicClient!, call.isValidAddyUpdate(...args)) as Promise<CallReturn<'isValidAddyUpdate'>>,
		isValidAddyDisable: (...args: ExtractArgs<Contract['calls']['isValidAddyDisable']>) => singleQuery(publicClient!, call.isValidAddyDisable(...args)) as Promise<CallReturn<'isValidAddyDisable'>>,
		isValidAddy: (...args: ExtractArgs<Contract['calls']['isValidAddy']>) => singleQuery(publicClient!, call.isValidAddy(...args)) as Promise<CallReturn<'isValidAddy'>>,
		isValidAddyId: (...args: ExtractArgs<Contract['calls']['isValidAddyId']>) => singleQuery(publicClient!, call.isValidAddyId(...args)) as Promise<CallReturn<'isValidAddyId'>>,
		getAddyId: (...args: ExtractArgs<Contract['calls']['getAddyId']>) => singleQuery(publicClient!, call.getAddyId(...args)) as Promise<CallReturn<'getAddyId'>>,
		getAddy: (...args: ExtractArgs<Contract['calls']['getAddy']>) => singleQuery(publicClient!, call.getAddy(...args)) as Promise<CallReturn<'getAddy'>>,
		getAddyInfo: (...args: ExtractArgs<Contract['calls']['getAddyInfo']>) => singleQuery(publicClient!, call.getAddyInfo(...args)) as Promise<CallReturn<'getAddyInfo'>>,
		getAddyDescription: (...args: ExtractArgs<Contract['calls']['getAddyDescription']>) => singleQuery(publicClient!, call.getAddyDescription(...args)) as Promise<CallReturn<'getAddyDescription'>>,
		getNumAddys: (...args: ExtractArgs<Contract['calls']['getNumAddys']>) => singleQuery(publicClient!, call.getNumAddys(...args)) as Promise<CallReturn<'getNumAddys'>>,
		getLastAddy: (...args: ExtractArgs<Contract['calls']['getLastAddy']>) => singleQuery(publicClient!, call.getLastAddy(...args)) as Promise<CallReturn<'getLastAddy'>>,
		getLastAddyId: (...args: ExtractArgs<Contract['calls']['getLastAddyId']>) => singleQuery(publicClient!, call.getLastAddyId(...args)) as Promise<CallReturn<'getLastAddyId'>>,
		isValidGovernor: (...args: ExtractArgs<Contract['calls']['isValidGovernor']>) => singleQuery(publicClient!, call.isValidGovernor(...args)) as Promise<CallReturn<'isValidGovernor'>>,
		addyInfo: (...args: ExtractArgs<Contract['calls']['addyInfo']>) => singleQuery(publicClient!, call.addyInfo(...args)) as Promise<CallReturn<'addyInfo'>>,
		addyToId: (...args: ExtractArgs<Contract['calls']['addyToId']>) => singleQuery(publicClient!, call.addyToId(...args)) as Promise<CallReturn<'addyToId'>>,
		numAddys: (...args: ExtractArgs<Contract['calls']['numAddys']>) => singleQuery(publicClient!, call.numAddys(...args)) as Promise<CallReturn<'numAddys'>>,
		governor: (...args: ExtractArgs<Contract['calls']['governor']>) => singleQuery(publicClient!, call.governor(...args)) as Promise<CallReturn<'governor'>>,
    
    // Mutations
		registerNewAddy: (...args: ExtractArgs<Contract['mutations']['registerNewAddy']>) => mutate(walletClient!, mutation.registerNewAddy)(...args),
		updateAddy: (...args: ExtractArgs<Contract['mutations']['updateAddy']>) => mutate(walletClient!, mutation.updateAddy)(...args),
		disableAddy: (...args: ExtractArgs<Contract['mutations']['disableAddy']>) => mutate(walletClient!, mutation.disableAddy)(...args),
		setGovernor: (...args: ExtractArgs<Contract['mutations']['setGovernor']>) => mutate(walletClient!, mutation.setGovernor)(...args),
  }
}
