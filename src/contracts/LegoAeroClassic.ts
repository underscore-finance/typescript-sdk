...
export type Contract = {
  ...
  events: {
    AerodromeSwap: (sender: `0x${string}`, tokenIn: `0x${string}`, tokenOut: `0x${string}`, amountIn: bigint, amountOut: bigint, usdValue: bigint, numTokens: bigint, recipient: `0x${string}`) => Promise<void>
    AerodromeLiquidityAdded: (sender: `0x${string}`, tokenA: `0x${string}`, tokenB: `0x${string}`, amountA: bigint, amountB: bigint, lpAmountReceived: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    AerodromeLiquidityRemoved: (sender: `0x${string}`, pool: `0x${string}`, tokenA: `0x${string}`, tokenB: `0x${string}`, amountA: bigint, amountB: bigint, lpToken: `0x${string}`, lpAmountBurned: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    AeroClassicCoreRouterPoolSet: (pool: `0x${string}`) => Promise<void>
    AeroClassicFundsRecovered: (asset: `0x${string}`, recipient: `0x${string}`, amount: bigint) => Promise<void>
    AerodromeLegoIdSet: (legoId: bigint) => Promise<void>
    AerodromeActivated: (isActivated: boolean) => Promise<void>
...
function getRequest<M extends Calls>(
  ...
  | {
    ...
    const call = {
      contractName: 'LegoAeroClassic' as const,
      method,
      args,
      address,
      deployAddress,
...
export const call: CallType = {
		...
		AERODROME_FACTORY: (...args: ExtractArgs<Contract['calls']['AERODROME_FACTORY']>) => getRequest('AERODROME_FACTORY', args),
		AERODROME_ROUTER: (...args: ExtractArgs<Contract['calls']['AERODROME_ROUTER']>) => getRequest('AERODROME_ROUTER', args),
...
export type SDK = {
		...
		AERODROME_FACTORY: (...args: ExtractArgs<Contract['calls']['AERODROME_FACTORY']>) => Promise<CallReturn<'AERODROME_FACTORY'>>
		AERODROME_ROUTER: (...args: ExtractArgs<Contract['calls']['AERODROME_ROUTER']>) => Promise<CallReturn<'AERODROME_ROUTER'>>
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		AERODROME_FACTORY: (...args: ExtractArgs<Contract['calls']['AERODROME_FACTORY']>) => singleQuery(publicClient!, call.AERODROME_FACTORY(...args)) as Promise<CallReturn<'AERODROME_FACTORY'>>,
		AERODROME_ROUTER: (...args: ExtractArgs<Contract['calls']['AERODROME_ROUTER']>) => singleQuery(publicClient!, call.AERODROME_ROUTER(...args)) as Promise<CallReturn<'AERODROME_ROUTER'>>,
