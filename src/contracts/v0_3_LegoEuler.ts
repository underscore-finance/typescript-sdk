...
export const deployAddress: Address | undefined = '0xB2a1cdC1D896eE37cD432b591FeC2664294286FB'
...
function getRequest<M extends Calls>(
  ...
  const call = {
    contractName: 'v0_3_LegoEuler' as const,
    method,
    args,
    address,
    deployAddress,
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    ...
    EULER_EVAULT_FACTORY: (...args: ExtractArgs<Contract['calls']['EULER_EVAULT_FACTORY']>) =>
      singleQuery(publicClient!, call.EULER_EVAULT_FACTORY(...args)) as Promise<CallReturn<'EULER_EVAULT_FACTORY'>>,
    EULER_EARN_FACTORY: (...args: ExtractArgs<Contract['calls']['EULER_EARN_FACTORY']>) =>
      singleQuery(publicClient!, call.EULER_EARN_FACTORY(...args)) as Promise<CallReturn<'EULER_EARN_FACTORY'>>,
