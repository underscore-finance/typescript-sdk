...
export type Contract = {
  ...
  events: {
    EulerDeposit: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountDeposited: bigint, usdValue: bigint, vaultTokenAmountReceived: bigint, recipient: `0x${string}`) => Promise<void>
    EulerWithdrawal: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountReceived: bigint, usdValue: bigint, vaultTokenAmountBurned: bigint, recipient: `0x${string}`) => Promise<void>
    EulerFundsRecovered: (asset: `0x${string}`, recipient: `0x${string}`, amount: bigint) => Promise<void>
    EulerRewardsAddrSet: (addr: `0x${string}`) => Promise<void>
    EulerLegoIdSet: (legoId: bigint) => Promise<void>
    EulerActivated: (isActivated: boolean) => Promise<void>
...
function getRequest<M extends Calls>(
  ...
  | {
    ...
    const call = {
      contractName: 'LegoEuler' as const,
      method,
      args,
      address,
      deployAddress,
...
export const call: CallType = {
		...
		assetOpportunities: (...args: ExtractArgs<Contract['calls']['assetOpportunities']>) => getRequest('assetOpportunities', args),
		indexOfAssetOpportunity: (...args: ExtractArgs<Contract['calls']['indexOfAssetOpportunity']>) => getRequest('indexOfAssetOpportunity', args),
		numAssetOpportunities: (...args: ExtractArgs<Contract['calls']['numAssetOpportunities']>) => getRequest('numAssetOpportunities', args),
		...
		EULER_EVAULT_FACTORY: (...args: ExtractArgs<Contract['calls']['EULER_EVAULT_FACTORY']>) => getRequest('EULER_EVAULT_FACTORY', args),
		EULER_EARN_FACTORY: (...args: ExtractArgs<Contract['calls']['EULER_EARN_FACTORY']>) => getRequest('EULER_EARN_FACTORY', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		assetOpportunities: (...args: ExtractArgs<Contract['calls']['assetOpportunities']>) => singleQuery(publicClient!, call.assetOpportunities(...args)) as Promise<CallReturn<'assetOpportunities'>>,
		indexOfAssetOpportunity: (...args: ExtractArgs<Contract['calls']['indexOfAssetOpportunity']>) => singleQuery(publicClient!, call.indexOfAssetOpportunity(...args)) as Promise<CallReturn<'indexOfAssetOpportunity'>>,
		numAssetOpportunities: (...args: ExtractArgs<Contract['calls']['numAssetOpportunities']>) => singleQuery(publicClient!, call.numAssetOpportunities(...args)) as Promise<CallReturn<'numAssetOpportunities'>>,
		vaultToAsset: (...args: ExtractArgs<Contract['calls']['vaultToAsset']>) => singleQuery(publicClient!, call.vaultToAsset(...args)) as Promise<CallReturn<'vaultToAsset'>>,
		...
		eulerRewards: (...args: ExtractArgs<Contract['calls']['eulerRewards']>) => singleQuery(publicClient!, call.eulerRewards(...args)) as Promise<CallReturn<'eulerRewards'>>,
		EULER_EVAULT_FACTORY: (...args: ExtractArgs<Contract['calls']['EULER_EVAULT_FACTORY']>) => singleQuery(publicClient!, call.EULER_EVAULT_FACTORY(...args)) as Promise<CallReturn<'EULER_EVAULT_FACTORY'>>,
		EULER_EARN_FACTORY: (...args: ExtractArgs<Contract['calls']['EULER_EARN_FACTORY']>) => singleQuery(publicClient!, call.EULER_EARN_FACTORY(...args)) as Promise<CallReturn<'EULER_EARN_FACTORY'>>,
    ...
    // Mutations
		...
		setEulerRewardsAddr: (...args: ExtractArgs<Contract['mutations']['setEulerRewardsAddr']>) => mutate(walletClient!, mutation.setEulerRewardsAddr)(...args),
		addAssetOpportunity: (...args: ExtractArgs<Contract['mutations']['addAssetOpportunity']>) => mutate(walletClient!, mutation.addAssetOpportunity)(...args),
		removeAssetOpportunity: (...args: ExtractArgs<Contract['mutations']['removeAssetOpportunity']>) => mutate(walletClient!, mutation.removeAssetOpportunity)(...args),
