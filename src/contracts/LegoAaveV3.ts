...
export type Contract = {
  ...
  events: {
    AaveV3Deposit: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountDeposited: bigint, usdValue: bigint, vaultTokenAmountReceived: bigint, recipient: `0x${string}`) => Promise<void>
...
export const call: CallType = {
		...
		AAVE_V3_ADDRESS_PROVIDER: (...args: ExtractArgs<Contract['calls']['AAVE_V3_ADDRESS_PROVIDER']>) => getRequest('AAVE_V3_ADDRESS_PROVIDER', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		AAVE_V3_POOL: (...args: ExtractArgs<Contract['calls']['AAVE_V3_POOL']>) => singleQuery(publicClient!, call.AAVE_V3_POOL(...args)) as Promise<CallReturn<'AAVE_V3_POOL'>>,
		AAVE_V3_ADDRESS_PROVIDER: (...args: ExtractArgs<Contract['calls']['AAVE_V3_ADDRESS_PROVIDER']>) => singleQuery(publicClient!, call.AAVE_V3_ADDRESS_PROVIDER(...args)) as Promise<CallReturn<'AAVE_V3_ADDRESS_PROVIDER'>>,
