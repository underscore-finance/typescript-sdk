...
export type Contract = {
  ...
  events: {
    UniswapV3Swap: (sender: `0x${string}`, tokenIn: `0x${string}`, tokenOut: `0x${string}`, amountIn: bigint, amountOut: bigint, usdValue: bigint, numTokens: bigint, recipient: `0x${string}`) => Promise<void>
    UniswapV3SwapInPool: (sender: `0x${string}`, pool: `0x${string}`, tokenIn: `0x${string}`, tokenOut: `0x${string}`, amountIn: bigint, amountOut: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    UniswapV3LiquidityAdded: (sender: `0x${string}`, tokenA: `0x${string}`, tokenB: `0x${string}`, amountA: bigint, amountB: bigint, liquidityAdded: bigint, nftTokenId: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    UniswapV3LiquidityRemoved: (sender: `0x${string}`, pool: `0x${string}`, nftTokenId: bigint, tokenA: `0x${string}`, tokenB: `0x${string}`, amountA: bigint, amountB: bigint, liquidityRemoved: bigint, usdValue: bigint, recipient: `0x${string}`) => Promise<void>
    UniV3FundsRecovered: (asset: `0x${string}`, recipient: `0x${string}`, amount: bigint) => Promise<void>
    UniV3CoreRouterPoolSet: (pool: `0x${string}`) => Promise<void>
    UniV3NftRecovered: (collection: `0x${string}`, nftTokenId: bigint, recipient: `0x${string}`) => Promise<void>
    UniswapV3LegoIdSet: (legoId: bigint) => Promise<void>
    UniswapV3Activated: (isActivated: boolean) => Promise<void>
...
function getRequest<M extends Calls>(
  ...
  | {
    ...
    const call = {
      contractName: 'LegoUniswapV3' as const,
      method,
      args,
      address,
      deployAddress,
...
export const call: CallType = {
		...
		UNIV3_FACTORY: (...args: ExtractArgs<Contract['calls']['UNIV3_FACTORY']>) => getRequest('UNIV3_FACTORY', args),
		UNIV3_NFT_MANAGER: (...args: ExtractArgs<Contract['calls']['UNIV3_NFT_MANAGER']>) => getRequest('UNIV3_NFT_MANAGER', args),
...
export type SDK = {
		...
		UNIV3_FACTORY: (...args: ExtractArgs<Contract['calls']['UNIV3_FACTORY']>) => Promise<CallReturn<'UNIV3_FACTORY'>>
		UNIV3_NFT_MANAGER: (...args: ExtractArgs<Contract['calls']['UNIV3_NFT_MANAGER']>) => Promise<CallReturn<'UNIV3_NFT_MANAGER'>>
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		UNIV3_FACTORY: (...args: ExtractArgs<Contract['calls']['UNIV3_FACTORY']>) => singleQuery(publicClient!, call.UNIV3_FACTORY(...args)) as Promise<CallReturn<'UNIV3_FACTORY'>>,
		UNIV3_NFT_MANAGER: (...args: ExtractArgs<Contract['calls']['UNIV3_NFT_MANAGER']>) => singleQuery(publicClient!, call.UNIV3_NFT_MANAGER(...args)) as Promise<CallReturn<'UNIV3_NFT_MANAGER'>>,
		UNIV3_QUOTER: (...args: ExtractArgs<Contract['calls']['UNIV3_QUOTER']>) => singleQuery(publicClient!, call.UNIV3_QUOTER(...args)) as Promise<CallReturn<'UNIV3_QUOTER'>>,
