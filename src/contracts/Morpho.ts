...
export const deployAddress: Address | undefined = '0x14852dcEEA98d5E781335bA8ea8d4B3a14508868'
...
export const call: CallType = {
  ...
  MORPHO_FACTORY_LEGACY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY_LEGACY']>) =>
    getRequest('MORPHO_FACTORY_LEGACY', args),
...
export type SDK = {
  ...
  abi: typeof abi
  events: {
    MorphoDeposit: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'MorphoDeposit'>[] }
    MorphoWithdrawal: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'MorphoWithdrawal'>[] }
  ...
  MORPHO_FACTORY_LEGACY: (
    ...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY_LEGACY']>
  ) => Promise<CallReturn<'MORPHO_FACTORY_LEGACY'>>
  ...
  return {
    ...
    events: {
      MorphoDeposit: {
        ...
        parse: (events: (RpcLog | Log)[]) => parseEvents('MorphoDeposit', events),
      },
      MorphoWithdrawal: {
        topic: getEventTopic('MorphoWithdrawal'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('MorphoWithdrawal', events),
      },
    ...
    getAccessForLego: (...args: ExtractArgs<Contract['calls']['getAccessForLego']>) =>
      ...
      >,
    morphoRewards: (...args: ExtractArgs<Contract['calls']['morphoRewards']>) =>
      singleQuery(publicClient!, call.morphoRewards(...args), {}, addressResolver) as Promise<
        CallReturn<'morphoRewards'>
      >,
    MORPHO_FACTORY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY']>) =>
      singleQuery(publicClient!, call.MORPHO_FACTORY(...args), {}, addressResolver) as Promise<
        CallReturn<'MORPHO_FACTORY'>
      >,
    MORPHO_FACTORY_LEGACY: (...args: ExtractArgs<Contract['calls']['MORPHO_FACTORY_LEGACY']>) =>
      singleQuery(publicClient!, call.MORPHO_FACTORY_LEGACY(...args), {}, addressResolver) as Promise<
        CallReturn<'MORPHO_FACTORY_LEGACY'>
      >,
