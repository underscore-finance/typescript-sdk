...
export const deployAddress: Address | undefined = '0x7192867D67329800345750f5A281Ce1352C3dF65'
...
export type SDK = {
  ...
  abi: typeof abi
  events: {
    CurveSwap: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'CurveSwap'>[] }
    CurveLiquidityAdded: { topic: Address; parse: (events: (RpcLog | Log)[]) => ParsedEvent<'CurveLiquidityAdded'>[] }
    CurveLiquidityRemoved: {
      topic: Address
      parse: (events: (RpcLog | Log)[]) => ParsedEvent<'CurveLiquidityRemoved'>[]
    }
...
export function toSdk(
  ...
  return {
    ...
    events: {
      CurveSwap: {
        topic: getEventTopic('CurveSwap'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('CurveSwap', events),
      },
      CurveLiquidityAdded: {
        topic: getEventTopic('CurveLiquidityAdded'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('CurveLiquidityAdded', events),
      },
      CurveLiquidityRemoved: {
        topic: getEventTopic('CurveLiquidityRemoved'),
        parse: (events: (RpcLog | Log)[]) => parseEvents('CurveLiquidityRemoved', events),
      },
      LegoPauseModified: {
    ...
    getDeepestLiqPool: (...args: ExtractArgs<Contract['calls']['getDeepestLiqPool']>) =>
      ...
      >,
    getBestSwapAmountOut: (...args: ExtractArgs<Contract['calls']['getBestSwapAmountOut']>) =>
      singleQuery(publicClient!, call.getBestSwapAmountOut(...args), {}, addressResolver) as Promise<
        CallReturn<'getBestSwapAmountOut'>
      >,
    getSwapAmountOut: (...args: ExtractArgs<Contract['calls']['getSwapAmountOut']>) =>
      singleQuery(publicClient!, call.getSwapAmountOut(...args), {}, addressResolver) as Promise<
        CallReturn<'getSwapAmountOut'>
      >,
    getBestSwapAmountIn: (...args: ExtractArgs<Contract['calls']['getBestSwapAmountIn']>) =>
      singleQuery(publicClient!, call.getBestSwapAmountIn(...args), {}, addressResolver) as Promise<
        CallReturn<'getBestSwapAmountIn'>
      >,
    getSwapAmountIn: (...args: ExtractArgs<Contract['calls']['getSwapAmountIn']>) =>
      singleQuery(publicClient!, call.getSwapAmountIn(...args), {}, addressResolver) as Promise<
    ...
    getAccessForLego: (...args: ExtractArgs<Contract['calls']['getAccessForLego']>) =>
      ...
      >,
    CURVE_META_REGISTRY: (...args: ExtractArgs<Contract['calls']['CURVE_META_REGISTRY']>) =>
      singleQuery(publicClient!, call.CURVE_META_REGISTRY(...args), {}, addressResolver) as Promise<
        CallReturn<'CURVE_META_REGISTRY'>
      >,
    CURVE_REGISTRIES: (...args: ExtractArgs<Contract['calls']['CURVE_REGISTRIES']>) =>
      singleQuery(publicClient!, call.CURVE_REGISTRIES(...args), {}, addressResolver) as Promise<
        CallReturn<'CURVE_REGISTRIES'>
      >,
