...
export type Contract = {
  ...
  events: {
    MoonwellDeposit: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountDeposited: bigint, usdValue: bigint, vaultTokenAmountReceived: bigint, recipient: `0x${string}`) => Promise<void>
...
export const call: CallType = {
		...
		MOONWELL_COMPTROLLER: (...args: ExtractArgs<Contract['calls']['MOONWELL_COMPTROLLER']>) => getRequest('MOONWELL_COMPTROLLER', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		MOONWELL_COMPTROLLER: (...args: ExtractArgs<Contract['calls']['MOONWELL_COMPTROLLER']>) => singleQuery(publicClient!, call.MOONWELL_COMPTROLLER(...args)) as Promise<CallReturn<'MOONWELL_COMPTROLLER'>>,
