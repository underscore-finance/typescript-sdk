...
export type Contract = {
  ...
  events: {
    CompoundV3Deposit: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountDeposited: bigint, usdValue: bigint, vaultTokenAmountReceived: bigint, recipient: `0x${string}`) => Promise<void>
    CompoundV3Withdrawal: (sender: `0x${string}`, asset: `0x${string}`, vaultToken: `0x${string}`, assetAmountReceived: bigint, usdValue: bigint, vaultTokenAmountBurned: bigint, recipient: `0x${string}`) => Promise<void>
...
export const call: CallType = {
		...
		COMPOUND_V3_CONFIGURATOR: (...args: ExtractArgs<Contract['calls']['COMPOUND_V3_CONFIGURATOR']>) => getRequest('COMPOUND_V3_CONFIGURATOR', args),
...
export function toSdk(publicClient?: PublicClient, walletClient?: WalletClient): SDK {
  return {
    // Queries
		...
		compoundRewards: (...args: ExtractArgs<Contract['calls']['compoundRewards']>) => singleQuery(publicClient!, call.compoundRewards(...args)) as Promise<CallReturn<'compoundRewards'>>,
		COMPOUND_V3_CONFIGURATOR: (...args: ExtractArgs<Contract['calls']['COMPOUND_V3_CONFIGURATOR']>) => singleQuery(publicClient!, call.COMPOUND_V3_CONFIGURATOR(...args)) as Promise<CallReturn<'COMPOUND_V3_CONFIGURATOR'>>,
    ...
    // Mutations
		...
		hasClaimableRewards: (...args: ExtractArgs<Contract['mutations']['hasClaimableRewards']>) => mutate(walletClient!, mutation.hasClaimableRewards)(...args),
		setCompRewardsAddr: (...args: ExtractArgs<Contract['mutations']['setCompRewardsAddr']>) => mutate(walletClient!, mutation.setCompRewardsAddr)(...args),
